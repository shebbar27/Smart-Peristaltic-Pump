...
public class MurhopyePumpControl extends PApplet {
...
public void createGUI(){
  ...
  flowRateSlider.setLimits(75.0f, 0.0f, 150.0f);
...
GButton stopButton; 
GLabel speedLable; 
  public void settings() {  size(600, 300, JAVA2D); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MurhopyePumpControl" };
    if (passedArgs != null) {
